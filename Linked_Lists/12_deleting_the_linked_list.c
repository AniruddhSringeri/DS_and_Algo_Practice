//contains insertion from front, insertion from end, deletion from front, deletion from end and deletion of total linked list.
...
void destroyEverything(struct node** head)
{
    struct node* temp;
    while(*head)
    {
...
int main()
{
    ...
    printf("Linked list program with insertion(both ends), deletion(both ends), display, and destroy(deletes whole linked list).\n");
    do 
    {
